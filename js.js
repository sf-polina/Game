...
function checkWinner(){
    ...
    var xy_1_4 = arr[12].innerHTML;
    var xy_1_5 = arr[16].innerHTML;

	var xy_2_1 = arr[2].innerHTML;
	var xy_2_2 = arr[4].innerHTML;
	var xy_2_3 = arr[6].innerHTML;
    var xy_2_4 = arr[8].innerHTML;
    var xy_2_5 = arr[10].innerHTML;

	if ((xy_1_1 && xy_1_2 && xy_1_3 && xy_1_4 && xy_1_5) || (xy_2_1 && xy_2_2 && xy_2_3 && xy_2_4 && xy_2_5)) {

		if (xy_1_1 == user_sym && xy_1_2 == user_sym && xy_1_3 == user_sym && xy_1_4 == user_sym && xy_1_5 == user_sym) {
			winner = user_sym;
		}
		else if(xy_1_1 == comp_sym && xy_1_2 == comp_sym && xy_1_3 == comp_sym && xy_1_4 == comp_sym && xy_1_5 == comp_sym){
			winner = comp_sym;
		}


		if (xy_2_1 == user_sym && xy_2_2 == user_sym && xy_2_3 == user_sym && xy_2_4 == user_sym && xy_2_5 == user_sym) {
			winner = user_sym;
		}
		else if(xy_2_1 == comp_sym && xy_2_2 == comp_sym && xy_2_3 == comp_sym && xy_2_4 == comp_sym && xy_2_5 == comp_sym){
			winner = comp_sym;
		}
	}
	...
	if (!winner){
		for(var i = 0; i < 5; i++){
            ...
            var a4 = arr[i + 9].innerHTML;
            var a5 = arr[i + 12].innerHTML;

			var b1 = arr[i].innerHTML;
			var b2 = arr[i + 1].innerHTML;
			var b3 = arr[i + 2].innerHTML;
            var b4 = arr[i + 4].innerHTML;
            var b5 = arr[i + 5].innerHTML;
			

			if (a1 == user_sym && a2 == user_sym && a3 == user_sym && a4 == user_sym && a5 == user_sym) {
				winner = user_sym;
				break;
			}
			else if(a1 == comp_sym && a2 == comp_sym && a3 == comp_sym && a4 == comp_sym && a5 == comp_sym){
				winner = comp_sym;
				break;
			}
            ...
            b4 = arr[j + 4].innerHTML;
            b5 = arr[j + 5].innerHTML;

			if (b1 == user_sym && b2 == user_sym && b3 == user_sym && b4 == user_sym && b5 == user_sym) {
				winner = user_sym;
				break;
			}
			else if(b1 == comp_sym && b2 == comp_sym && b3 == comp_sym  && b4 == comp_sym  && b5 == comp_sym){
				winner = comp_sym;
				break;
			}
			if (winner) 
